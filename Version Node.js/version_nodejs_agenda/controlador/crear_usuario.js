    ...
    Usuario.find({}, (err, usuarios) => {
      if (err) {
        ...
        if (usuarios.length <= 0) {
			...
			nuevoUsuario1.nombre = 'Edgar Lemus'
			nuevoUsuario1.email = 'edgar_duvan_l_r@hotmail.com'
			...
			nuevoUsuario2.nombre = 'Zeus Anthonio'
			nuevoUsuario2.email = 'zeus2018@gamil.com'
			nuevoUsuario2.clave = 'zeuscat'
