<?php
	...
	//REVOKE ALL PRIVILEGES ON nextu_Edgar_SQL FROM 'login_user'@'localhost';
	//GRANT SELECT (emai, clave) ON nextu_Edgar_SQL.usuarios TO 'login_user'@'localhost';

  $con = new ConectorBD('localhost','root','');
	$respuesta['msg'] = $con->iniciarConexion('nextu_Edgar_SQL');
